            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                <div className="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-green-500 hover:shadow-xl transition">
                  ...
                  <p className="text-gray-600 text-sm font-medium mb-1">Solicitudes Activas</p>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-blue-500 hover:shadow-xl transition">
                  ...
                  <p className="text-gray-600 text-sm font-medium mb-1">Propuestas Recibidas</p>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  >
                    <Package className="text-blue-600 group-hover:scale-110 transition" size={24} />
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-sm text-gray-600">{totalProposals} propuestas</p>
                    </div>
                    ...
                    {bookings.slice(0, 5).map((booking) => (
                      <div key={booking.id} className="flex items-center gap-4 p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-600">{new Date(booking.scheduledDate).toLocaleDateString('es-ES')}</p>
                        </div>
