          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="max-w-3xl mx-auto mb-16">
              <div className="bg-white rounded-3xl shadow-2xl p-3 flex items-center gap-3 hover:shadow-3xl transition-shadow">
                ...
                />
                <Link href="/servicios">
                  <button className="bg-gradient-to-r from-[#FF2D55] to-[#FF6900] hover:from-[#FF1D45] hover:to-[#FF5900] text-white px-10 py-5 rounded-2xl font-bold transition-all transform hover:scale-105 flex items-center gap-2 shadow-lg">
                    Buscar
