...
// ... existing code ...
    ...
    nav: {
      ...
      wrapper: 'max-w-7xl mx-auto px-2 sm:px-6 lg:px-8',
      menu: 'flex gap-0.5 sm:gap-1 overflow-x-auto scrollbar-hide',
      item: {
        base: 'flex items-center gap-2 sm:gap-2 px-4 sm:px-4 py-3 sm:py-3 text-sm font-medium border-b-2 transition-all duration-200 whitespace-nowrap',
