...
export const DEFAULT_AUTOMATION_RULES = [
  ...
  // ── DOCUMENTOS ──────────────────────────────────────────
  {
    name: 'Documentos Aprobados (SMS)',
    description: 'Notificación inmediata al socio cuando sus documentos son aprobados.',
    ...
    waTemplateFn: null,
    subject: null,
    customBody: 'LoHaggo: ¡Hola {{name}}! Tu documento fue aprobado exitosamente. Continúa con el proceso de verificación en https://lohaggo.com/app',
    isActive: true,
  },
  {
    name: 'Documentos Rechazados (SMS)',
    description: 'Notificación inmediata al socio cuando sus documentos son rechazados.',
    ...
    waTemplateFn: null,
    subject: null,
    customBody: 'LoHaggo: Hola {{name}}, tu documento fue rechazado. Revisa los detalles y vuelve a intentarlo en https://lohaggo.com/app',
    isActive: true,
  },
  {
    name: 'Socio Activado (SMS + Email)',
