...
const services = [
  ...
  { name: "Carpintería", slug: "carpinteria", description: "Fabricación y reparación de muebles", icon: "🪚", category: "hogar", basePrice: 140000, duration: 180, popular: true },
  ...
  { name: "Jardinería", slug: "jardineria", description: "Mantenimiento de jardines y áreas verdes", icon: "🌱", category: "hogar", basePrice: 90000, duration: 120, popular: true },
  { name: "Fumigación", slug: "fumigacion", description: "Control de plagas y fumigación", icon: "🦟", category: "hogar", basePrice: 110000, duration: 90, popular: true },
  { name: "Lavado de alfombras", slug: "lavado-alfombras", description: "Limpieza profunda de alfombras y tapetes", icon: "🧼", category: "limpieza", basePrice: 70000, duration: 60, popular: true },
  ...
  { name: "Entrenador personal", slug: "entrenador-personal", description: "Entrenamiento físico personalizado", icon: "💪", category: "salud", basePrice: 80000, duration: 60, popular: false },
  ...
  { name: "Reparación de celulares", slug: "reparacion-celulares", description: "Reparación de smartphones y tablets", icon: "📱", category: "tecnologia", basePrice: 80000, duration: 60, popular: false },
  ...
  { name: "Mensajería", slug: "mensajeria", description: "Entrega de paquetes y documentos", icon: "📮", category: "transporte", basePrice: 30000, duration: 60, popular: false },
  ...
  { name: "Clases de idiomas", slug: "clases-idiomas", description: "Enseñanza de idiomas extranjeros", icon: "🗣️", category: "educacion", basePrice: 70000, duration: 60, popular: false },
