...
export function BottomNav() {
  ...
  // Partner pages have their own PartnerDashboardNav under the header — no bottom bar needed
  const isPartnerPage = isPartner && (pathname.startsWith('/partner') || pathname === '/profile')
